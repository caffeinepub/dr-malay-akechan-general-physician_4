...
export default function HeaderEditor({ sessionToken, currentText, currentImageUrl, currentImageBase64 }: HeaderEditorProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-heading font-bold text-foreground mb-1">Header</h2>
        <p className="text-muted-foreground text-sm">Edit the site title and header/logo image.</p>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6 space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-foreground" htmlFor="site-title">
          ...
          <div className="shrink-0">
            {previewSrc ? (
              <div className="w-32 h-20 rounded-xl overflow-hidden border-2 border-cyan-500/30 shadow-lg">
                <img src={previewSrc} alt="Header preview" className="w-full h-full object-cover" />
              </div>
            ) : (
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will permanently remove the header/logo image. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
