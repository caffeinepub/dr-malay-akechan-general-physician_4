...
import type { ClinicInput, ServiceInput, SocialLinkInput, HeroSettings, AboutImage } from '../backend';
...
export function useUpdateHeroSettings() {
  ...
  return useMutation({
    mutationFn: async ({ settings, sessionToken }: { settings: HeroSettings; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateAboutSection() {
  ...
  return useMutation({
    mutationFn: async ({ text, sessionToken }: { text: string; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateAboutImage() {
  ...
  return useMutation({
    mutationFn: async ({ newImage, sessionToken }: { newImage: AboutImage; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateHeaderImageBase64() {
  ...
  return useMutation({
    mutationFn: async ({ imageBase64, sessionToken }: { imageBase64: string; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateHeroBackgroundImage() {
  ...
  return useMutation({
    mutationFn: async ({ imageUrl, imageBase64, sessionToken }: { imageUrl: string; imageBase64: string; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useAddClinic() {
  ...
  return useMutation({
    mutationFn: async ({ clinic, sessionToken }: { clinic: ClinicInput; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateClinic() {
  ...
  return useMutation({
    mutationFn: async ({ id, clinic, sessionToken }: { id: bigint; clinic: ClinicInput; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useAddService() {
  ...
  return useMutation({
    mutationFn: async ({ service, sessionToken }: { service: ServiceInput; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateService() {
  ...
  return useMutation({
    mutationFn: async ({ id, service, sessionToken }: { id: bigint; service: ServiceInput; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateServiceIconBase64() {
  ...
  return useMutation({
    mutationFn: async ({ serviceId, imageBase64, sessionToken }: { serviceId: bigint; imageBase64: string; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useDeleteServiceIcon() {
  ...
  return useMutation({
    mutationFn: async ({ serviceId, sessionToken }: { serviceId: bigint; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useAddSocialLink() {
  ...
  return useMutation({
    mutationFn: async ({ link, sessionToken }: { link: SocialLinkInput; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateSocialLink() {
  ...
  return useMutation({
    mutationFn: async ({ id, link, sessionToken }: { id: bigint; link: SocialLinkInput; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
...
export function useUpdateFooterContent() {
  ...
  return useMutation({
    mutationFn: async ({ content, sessionToken }: { content: string; sessionToken: string }) => {
      if (!actor) throw new Error('Actor not available');
