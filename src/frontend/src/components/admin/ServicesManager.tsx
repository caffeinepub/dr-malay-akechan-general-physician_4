...
export default function ServicesManager({
  ...
  const updateMutation = useMutation({
    mutationFn: async ({
      id,
      service,
    }: { id: bigint; service: ServiceInput }) => {
      if (!actor) throw new Error("Actor not available");
    ...
    onError: (err: any) => {
      toast.error(
        `Failed to update service: ${err?.message ?? "Unknown error"}`,
      );
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (err: any) => {
      toast.error(
        `Failed to delete service: ${err?.message ?? "Unknown error"}`,
      );
    },
  });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Manage the medical services you offer.
          </p>
        </div>
        <button
          type="button"
            ...
            <div key={id.toString()}>
              {editingId === id ? (
                <ServiceForm
                  ...
                  onSave={() =>
                    updateMutation.mutate({ id, service: editService })
                  }
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                onClick={() => deleteIconMutation.mutate(id)}
                              >
                                Remove Icon
                              </AlertDialogAction>
                            </AlertDialogFooter>
