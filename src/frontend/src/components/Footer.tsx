    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 mb-10 sm:mb-12">
          ...
          <div>
            <h4
              className="font-heading font-semibold text-sm sm:text-base mb-3 sm:mb-4"
              ...
              {["About", "Services", "Clinics", "Contact"].map((item) => (
                <li key={item}>
                  <a
                    ...
                    onMouseLeave={(e) => {
                      e.currentTarget.style.color = "oklch(0.78 0.012 220)";
                    }}
                  >
                    {item}
                  </a>
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <p
              ...
              style={{ color: "oklch(0.78 0.012 220)" }}
            >
              For appointments and inquiries, please visit one of our clinic
              locations.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-center sm:text-left">
          ...
          >
            ...
            <a
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = "oklch(0.72 0.18 195)";
              }}
            >
              caffeine.ai
            </a>
