      ...
      {phone && (
        <div className="flex items-center gap-2.5">
          ...
          <a
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.color = "oklch(0.80 0.010 220)";
            }}
          >
            {phone}
          </a>
      ...
      <div className="flex flex-col sm:flex-row gap-2.5 pt-2">
        {bookingUrl && (
          <a
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.65 0.185 195), oklch(0.58 0.175 240))",
              color: "oklch(0.98 0.005 220)",
              boxShadow: "0 4px 16px oklch(0.65 0.185 195 / 0.30)",
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.boxShadow =
                "0 6px 24px oklch(0.65 0.185 195 / 0.50)";
              (e.currentTarget as HTMLAnchorElement).style.transform =
                "translateY(-1px)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.boxShadow =
                "0 4px 16px oklch(0.65 0.185 195 / 0.30)";
              (e.currentTarget as HTMLAnchorElement).style.transform =
                "translateY(0)";
            }}
          >
          ...
          <a
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.background =
                "oklch(0.72 0.18 195 / 0.18)";
              (e.currentTarget as HTMLAnchorElement).style.borderColor =
                "oklch(0.72 0.18 195 / 0.55)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.background =
                "oklch(0.72 0.18 195 / 0.08)";
              (e.currentTarget as HTMLAnchorElement).style.borderColor =
                "oklch(0.72 0.18 195 / 0.35)";
            }}
          >
